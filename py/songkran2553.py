...
data = pd.read_csv("year2553.csv")
day = range(1, 8)
dic['Number of Accidents'] = data['accidents']
dic['Number of Injured'] = data['injuries']
dic ['Number of Deaths'] = data['deaths']
line_chart = pg.Line(style=DarkStyle)
line_chart.x_labels = day
line_chart.title = 'graph of deaths and injuries and accidents during 7 Days dangerous in Songkran Festival in 2553'
# import file
# 7 days dangerous
...
line_chart.render_to_file('Songkran in 2553.svg')
# create cahart
# export file svg

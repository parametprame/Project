...
line_chart.title = 'graph of deaths and injuries and accidents during 7 Days dangerous in Songkran Festival in 2555'
# import file
# 7 days dangerous
...
line_chart.render_to_file('Songkran in 2555.svg'
# create cahart
# export file svg
